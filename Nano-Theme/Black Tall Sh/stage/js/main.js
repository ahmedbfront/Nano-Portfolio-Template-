...
$(function () {
  ...
  $(".nav-item").on("click", function () {
    ...
    if ($(window).width() < 992) {
      ...
      $("html, body").animate(
        {
          scrollTop: $("." + $(this).data("section")).offset().top - 65,
        },
        1000
      );
    }
...
var mainVal = document.documentElement.style.getPropertyValue("--main--color");
var darkMode = document.querySelector(".dark-mode");
var elBox = document.querySelector("#box");

darkMode.onclick = function () {
  if (elBox.classList.contains("dark")) {
    document.documentElement.style.setProperty("--main--color", mainVal);
  } else {
